...
const doctors = [
  {
    name: "Dr. Rajesh Sharma", role: "Chief Medical Officer", specialty: "Internal Medicine", exp: "20+ years", avatar: "RS",
  ...
  {
    name: "Dr. Priya Nair", role: "Head of Pediatrics", specialty: "Pediatric Care", exp: "15+ years", avatar: "PN",
  ...
  {
    name: "Dr. Arun Patel", role: "Lead Diagnostician", specialty: "Diagnostic Medicine", exp: "12+ years", avatar: "AP",
  ...
  {
    name: "Dr. Sneha Gupta", role: "Women's Health Lead", specialty: "Gynaecology", exp: "18+ years", avatar: "SG",
  ...
  {
    name: "Dr. Vikram Singh", role: "Preventive Care & Wellness", specialty: "Wellness & Prevention", exp: "10+ years", avatar: "VS",
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div className="flex flex-col md:flex-row items-start gap-8">
              <div className="w-32 h-32 md:w-40 md:h-40 rounded-full gradient-teal flex items-center justify-center text-primary-foreground text-4xl md:text-5xl font-bold flex-shrink-0 ring-4 ring-primary/20 mx-auto md:mx-0">
                {activeDoctor.avatar}
              </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4">
            {doctors.map((doc, i) => (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
              >
                <div className={`w-14 h-14 rounded-full mx-auto flex items-center justify-center text-lg font-bold ${i === activeIndex ? "gradient-teal text-primary-foreground" : "bg-secondary text-secondary-foreground"}`}>
                  {doc.avatar}
                </div>
